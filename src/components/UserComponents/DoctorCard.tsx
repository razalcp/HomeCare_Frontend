...
//   // 🔁 Debounce logic (runs on every searchText change)
//   useEffect(() => {
...
//     return () => clearTimeout(delay); // Clear timer on unmount or change
//   }, [searchText]);

//   // 🧠 Fetch doctors based on debounced search, sorting, price, page
//   useEffect(() => {
//     const fetchDoctors = async () => {
//       setLoading(true);
//       setError('');
...
//               <button
//                 className="px-4 py-2 bg-red-400 text-white rounded-md hover:bg-red-600"
//                 onClick={() => { setSearchText(''); setDebouncedSearchText(''); setCurrentPage(1); }}
//               >
//                 Clear
//               </button>
//             )}
